---
description: Conventions for the upstream market-data cleaning stage — statistical outlier/stale detection, gap handling, versioned checksummed clean snapshots. Apply to any data-cleaning, validation, or market-data-ingestion code. Keeps cleaning OUT of the pricing core.
applyTo: "**/cleaning/**/*.py,**/ingest/**/*.py,**/ingestion/**/*.py,**/market_data/**/*.py"
---
