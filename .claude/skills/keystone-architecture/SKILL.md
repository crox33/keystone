...
description: Architectural conventions and invariants for the keystone clearing-risk library. Use whenever writing, reviewing, or extending keystone code — adding a pricer, risk measure, adapter, or orchestrator — to stay on-pattern. Covers the hexagonal seams, units discipline, vectorisation rule, and the margin/backtest single-core rule.
---
